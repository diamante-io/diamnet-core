...
void
SurveyManager::relayOrProcessResponse(DiamnetMessage const& msg,
                                      Peer::pointer peer)
{
...
void
SurveyManager::relayOrProcessRequest(DiamnetMessage const& msg,
                                     Peer::pointer peer)
{
...
void
SurveyManager::broadcast(DiamnetMessage const& msg) const
{
...
std::string
SurveyManager::getMsgSummary(DiamnetMessage const& msg)
{
    std::string summary;
