# SCP (Diamnet Consensus Protocol)
...
in the file [Diamnet-SCP.x](../xdr/Diamnet-SCP.x), however, library users are
most likely to want to modify [`Diamnet-types.x`](../xdr/Diamnet-types.x),
...
The `diamnet-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.diamnet.org/papers/diamnet-consensus-protocol.pdf).
