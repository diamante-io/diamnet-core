...
class QuorumIntersectionCheckerImpl : public diamnet::QuorumIntersectionChecker
{
    ...
    // reporting.
    mutable std::pair<std::vector<diamnet::NodeID>,
                      std::vector<diamnet::NodeID>>
        mPotentialSplit;
    ...
    std::vector<diamnet::NodeID> mBitNumPubKeys;
    std::unordered_map<diamnet::NodeID, size_t> mPubKeyBitNums;
    QGraph mGraph;
    ...
    mutable diamnet::RandomEvictionCache<BitSet, bool, BitSet::HashFunction>
        mCachedQuorums;
  ...
  public:
    ...
    std::pair<std::vector<diamnet::NodeID>, std::vector<diamnet::NodeID>>
