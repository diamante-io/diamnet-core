...
class HerderImpl : public Herder
{
  public:
    ...
    void setTrackingSCPState(uint64_t index, DiamnetValue const& value,
    ...
    virtual DiamnetValue
    makeDiamnetValue(Hash const& txSetHash, uint64_t closeTime,
                     xdr::xvector<UpgradeType, 6> const& upgrades,
  ...
  private:
    ...
    void newSlotExternalized(bool synchronous, DiamnetValue const& value);
