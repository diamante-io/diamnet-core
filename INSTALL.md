...
`diamnet-core` does not have many dependencies.
...
#### Ubuntu 18.04
You can install the [test toolchain](#adding-the-test-toolchain) to build and run diamnet-core with the latest version of the llvm toolchain.
