...
(
  ...
  rsync -a -HAX --files-from=- /workspaces/diamnet-core/ ~/src/diamnet-core
```
...
```
  git ls-files -m | xargs -I'{}' -n1 -- cp '{}' ~/src/diamnet-core/'{}'
```
...
(
  ...
  rsync --progress -v -ru -C --files-from=- ~/src/diamnet-core /workspaces/diamnet-core
```
